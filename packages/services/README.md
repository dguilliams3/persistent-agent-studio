...
| **Image Generation** | `src/image_generation/` | Image gen (CloudflareAIProvider, native Workers AI) |
...
import { CloudflareAIProvider } from '@persistence/services/image_generation';
...
│   ├── types.ts                   # ImageService, ImageOptions
│   └── cloudflare.ts              # CloudflareAIProvider (native Workers AI)
