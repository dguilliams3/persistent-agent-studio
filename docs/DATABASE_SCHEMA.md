...
**Last Updated:** 2026-01-14 (snapshot at schema v15)
**Database:** Cloudflare D1 (SQLite-compatible)
**Current Version:** v15 **at the time of writing — the schema has moved on (v25+)**

> **Provenance (2026-07-31):** this is a **v15-era snapshot** and is kept for narrative
> value (the design rationale per table still reads true). The ground truth for the
> current schema is `platforms/cloudflare/schema.sql` plus the ordered
> `platforms/cloudflare/migration_v*.sql` files; `docs/ERD.md` tracks the v25 tier
> refactor. Do not build against the column lists below without checking the migrations.
