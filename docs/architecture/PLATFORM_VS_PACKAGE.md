...
| `env.AI` | Cloudflare AI binding | Image generation + Whisper STT |
...
**Everything else is just JavaScript.** Telegram, Discord, Anthropic, OpenAI, ElevenLabs, Brave - all just HTTP calls.
