...
This guide covers Cloudflare Workers billing for this project.

> **Provenance (2026-07-31):** dated snapshot — Cloudflare's plan prices and free-tier
> limits change; verify against [Cloudflare's pricing page](https://www.cloudflare.com/plans/)
> before relying on any figure below. The durable claim (a single persona fits
> comfortably in the Workers/D1 free tiers) has held.
