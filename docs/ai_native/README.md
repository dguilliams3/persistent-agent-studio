...
| `SUMMARIZATION.md` | Three-tier summary system | Working on summarization |
| `CONTEXT_ASSEMBLY.md` | Context window & caching | Modifying prompt assembly |
| `CONTEXT_WINDOW_ROLLING.md` | How the window rolls forward | Working on memory continuity |
| `RAG_SYSTEM.md` | Embeddings & retrieval | Working on semantic search |
| `RESPONSE_NORMALIZER.md` | Raw LLM output → validated actions | Provider/parser work |
| `BATCH_MODE.md` | Batch API (~0.5x rate) | Working on batch processing |
