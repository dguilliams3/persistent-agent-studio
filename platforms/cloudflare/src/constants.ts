...
// ============================================================================
// Settings for native Cloudflare Workers AI image generation.
// ============================================================================

/**
 * @description Default negative prompt for the Workers AI Stable Diffusion XL model
 * Applied to: Cloudflare AI (@cf/stabilityai/stable-diffusion-xl-base-1.0)
 *
