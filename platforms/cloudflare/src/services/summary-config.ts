...
// A formatConfigForTelegram helper lived here. It had no callers anywhere in the
// repo, formatted for a channel adapter this distribution does not ship, and its
// emoji had been mangled into replacement characters by an encoding round-trip.
// Read config through getSummaryConfig() and format it for the surface you are
// actually rendering to.
