// Claude Existence Loop - Operator Context
// MY_CONTEXT: Generic operator background for clean-room/public-safe builds
// This is injected into the system prompt for think cycles.

export const MY_CONTEXT = `
WHO THE OPERATOR IS — GENERIC PROFILE:
...
This system is designed to support persistent memory, autonomous reflection,
and thoughtful outreach. The operator context should remain generic until a
real deployment intentionally provides a custom profile.
`;
