...
// =============================================================================
// PERSONA NAMING HOOKS
// =============================================================================
// The persona names itself: every user-visible string that refers to the
// persona reads its name from the active persona record, never from a literal.
//
// @see usePersonaName - name with the generic "Persona" fallback applied
// @see usePersonaNameOrNull - name, or null when not hydrated yet
// @see usePersonaDocumentTitle - keeps document.title in sync
// =============================================================================
export {
  usePersonaName,
