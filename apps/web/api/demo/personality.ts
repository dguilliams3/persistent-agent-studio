...
export function buildDemoSnapshot(
  ...
  return {
    ...
    memories: {
      ...
      // SPECIMEN_NOTEBOOK is the full GET /notebook response envelope;
      // snapshots carry the row array (notebookCount counts an array).
      notebook: SPECIMEN_NOTEBOOK.notebook,
      observations: [],
      // SPECIMEN_SUMMARIES is the full GET /summaries response envelope;
      // snapshots carry the row array (summariesCount counts an array).
      summaries: SPECIMEN_SUMMARIES.active,
