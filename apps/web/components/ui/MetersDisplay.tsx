 ...
 * @description Displays the persona's internal state meters with visual bars and history trends.
 ...
 * - Vocabulary for gradients - gives the persona language for "partially alive" vs binary states
 * - Trailing history creates temporal context - patterns over time, not just snapshots
 *
 * @upstream Called by: ChatTab, SettingsTab, or any component showing the persona's state
