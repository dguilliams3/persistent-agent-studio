...
export function MessageInput({
  ...
  const canSend = !disabled && (normalizedValue.trim().length > 0 || !!imagePreview);
      ...
      >
        ...
        <input
          ...
          style={{
            ...
            maxHeight: '100px',
            /* Placeholder/value that outgrows a narrow composer ellipsizes
               instead of severing mid-glyph (ledger §2 row 9, mobile half).
               Browsers drop the ellipsis while the input is focused, which
               is the editing behavior you want. */
