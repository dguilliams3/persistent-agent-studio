...
import { formatTime as formatDbTimestamp } from '../ui/historyUtils';
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', height: '100%' }}>
      ...
      >
        ...
        <a
          href="/efficiencies"
          data-testid="settings-efficiencies-link"
          style={{ color: 'var(--text-muted)', textDecoration: 'underline' }}
        >
  ...
  return (
    ...
    <div className="app-shell-root" style={{
      ...
      {/* Lightbox — rendered outside layout for proper overlay.
          formatTime: chat's timestamp convention, not a raw toLocaleString
          dump with seconds (ledger §2 row 13); includes the UTC-parse fix. */}
      <Lightbox
        formatTime={formatDbTimestamp}
