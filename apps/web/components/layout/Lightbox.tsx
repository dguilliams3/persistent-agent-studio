          ...
          {current?.id && (
            <div className="flex gap-3 justify-center mt-4">
              ...
              <button
                onClick={(e) => {
                  e.stopPropagation();
                  // KNOWN RESIDUE: last native prompt() in the Media surface.
                  // The pattern this once cited (data.ts deleteLearning) now
                  // collects its password via an in-card confirm strip
                  // (ledger §2 row 17) — this site should follow; it just
                  // wasn't in the row-17 residue scope. Only call if provided.
