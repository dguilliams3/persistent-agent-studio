 ...
 *
 * The SIM tab tracks the persona's semantic identity evolution through embedding space,
          ...
          {basin.global.computedAt && (
            <span>
              {/* Chat's formatTime is the app-wide timestamp convention
                  (ledger §2 row 13) — no raw locale dumps with seconds. */}
              Last computed: {formatTime(basin.global.computedAt)}
            </span>
          )}
        </div>
      )}
