...
export function useSIMData() {
  ...
  // Weekly drift buckets
  const simWeeklyBuckets = useAppStore((s) => s.simWeeklyBuckets);
  const simWeeklyType = useAppStore((s) => s.simWeeklyType);
  const simWeeklyLoading = useAppStore((s) => s.simWeeklyLoading);
  ...
  const fetchWeeklyBasin = useAppStore((s) => s.fetchWeeklyBasin);
  ...
  return {
    ...
    weekly: simWeeklyBuckets,
    weeklyType: simWeeklyType,
    weeklyLoading: simWeeklyLoading,
