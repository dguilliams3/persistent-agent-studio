 ...
 * breathing logo animation, cyan accent inputs and button. First impression of
 * the persona living here.
 *
 * The card names the persona only when the app already knows the name (a
 * returning session whose persona record has hydrated). Pre-auth on a fresh
 * deployment there is no name to show, so the card falls back to the
 * persona-independent product title rather than borrowing the reference
 * persona's name.
 *
 ...
 *   - usePersonaNameOrNull() hook - active persona name, null when unknown
...
import { APP_TITLE, usePersonaNameOrNull } from '../../hooks/usePersonaName';
