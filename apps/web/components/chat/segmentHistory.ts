...
export const USER_BUBBLE_TYPES = new Set(['user_message']);
 ...
 *
 * Exported as the app's canonical day-header convention: the chat surface
 * set it, and other surfaces (MediaView's day groups) reuse it rather than
 * invent a fourth date format (ledger §2 row 13). Includes the UTC-parse
 * fix via parseDbTimestamp above.
 */
