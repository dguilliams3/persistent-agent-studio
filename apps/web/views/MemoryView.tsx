...
import { formatTime } from '../components/ui/historyUtils';
  ...
  return (
    <div style={{
      ...
      <div style={{ flex: 1, overflow: 'auto', padding: 'var(--spacing-md)' }}>
        ...
        {mode === 'manage' && (
          /* Chat's formatTime is the app-wide timestamp convention (ledger
             §2 row 13) — includes the UTC-parse fix; the old local helper
             here was a raw seconds-bearing toLocaleString(). */
